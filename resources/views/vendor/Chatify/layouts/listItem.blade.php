...
{{-- -------------------- Search Item (SOLUCIÓN MOUSEDOWN) -------------------- --}}
@if($get == 'search_item')
<table class="messenger-list-item" 
       data-contact="{{ $user->id }}" 
       onmousedown="window.location.href = '{{ route('chatify') }}/{{ $user->id }}'" {{-- <--- LA CLAVE ESTÁ AQUÍ --}}
       style="width: 100%; cursor: pointer; position: relative; z-index: 50;">
    <tr data-action="0">
        {{-- Avatar side --}}
