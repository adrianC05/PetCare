        ...
        <main class="max-w-5xl w-full flex flex-col lg:flex-row bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] overflow-hidden">
            ...
            <div class="flex-1 p-8 sm:p-16 lg:p-20 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-gray-100">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    @auth
                    <a href="{{ url('/admin') }}" class="flex-1 text-center bg-gray-900 text-white py-5 rounded-2xl font-bold hover:bg-orange-600 hover:-translate-y-1 transition-all shadow-xl shadow-gray-200">
                        Ir al Panel de Control
                    </a>
                    @else
                    <a href="{{ url('/admin/login') }}" class="flex-1 text-center bg-orange-500 text-white py-5 rounded-2xl font-bold hover:bg-gray-900 hover:-translate-y-1 transition-all shadow-xl shadow-orange-100">
                        Iniciar Sesión
                    </a>
                    @endauth
                </div>
